...
export class CraneCellResponseDto {
  @ApiProperty({ description: '크레인 셀 ID', example: 1, default: -1, type: Number })
  @Expose()
  id: number;
  ...
  @ApiProperty({ description: 'level 정보', example: '4', default: true, type: Number })
  @Expose()
  level: number;
